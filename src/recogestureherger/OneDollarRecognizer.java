...
// a single gesture. 
    ...
    class Recognizer {
        ...
        Recognizer() {
            ...
            // arrow
            Point[] point7 = {new Point(68, 222), new Point(70, 220),
            ...
            // left square bracket
            Point[] point8 = {new Point(140, 124), new Point(138, 123),
            ...
            Point[] point9 = {new Point(112, 138), new Point(112, 136),
            ...
            // v
            Point[] point10 = {new Point(89, 164), new Point(90, 162),
            ...
            // delete
            Point[] point11 = {new Point(123, 129), new Point(123, 131),
            ...
            // left curly brace
            Point[] point12 = {new Point(150, 116), new Point(147, 117),
            ...
            // right curly brace
            Point[] point13 = {new Point(117, 132), new Point(115, 132),
            ...
            // star
            Point[] point14 = {new Point(75, 250), new Point(75, 247),
            ...
            // pig tail
            Point[] point15 = {new Point(81, 219), new Point(84, 218),
    ...
    public ArrayList<Point> rotateBy(ArrayList<Point> points, double theta) {
        Point c = centroid(points);
    ...
    public ArrayList<Point> scaleToSquare(ArrayList<Point> points, double sz) {
    ...
    public double DistanceAtAngle(ArrayList<Point> points, Template T, double theta) {
        ArrayList<Point> newpoints = rotateBy(points, theta);
        return pathDistance(newpoints, T.Points);
    }

    public double pathDistance(ArrayList<Point> pts1, ArrayList<Point> pts2) {
    ...
    public Rectangle boundingBox(ArrayList<Point> points) {
